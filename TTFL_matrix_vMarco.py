# -*- coding: utf-8 -*-
"""
Created on Wed Dec 26 20:00:09 2018
...
# restriction 30 days
#nba_30 = all_nba_stat[all_nba_stat["date_match"] >= datetime.date.today() - datetime.timedelta(30)]
#nba_30 = nba_30[['joueur','ttfl']].groupby("joueur").mean()
#nba_30=nba_30.reset_index(level=['joueur'])

# ajout de la moyenne 
#all_nba_stat = pd.merge(all_nba_stat, nba_30, on="joueur")
#all_nba_stat = all_nba_stat.rename(index=str, columns={"ttfl_x": "ttfl", "ttfl_y": "ttfl_30"})
#pp.pprint(all_nba_stat)
...
np.savetxt("C:\\Users\\DI STASIO\\Desktop\\TTFL\\TTFL.csv", matrix, delimiter=",")
np.savetxt("C:\\Users\\DI STASIO\\Desktop\\TTFL\\noms.csv",noms,fmt="%s")
np.savetxt("C:\\Users\\DI STASIO\\Desktop\\TTFL\\calendrier.csv",dates,fmt="%s")
